...
SAMPLE_LIMIT = None
RAW_DATA_FILE = "/home/matthias/Projects/Autoformer/dataset/btc_usd/btc_usd_minute_reduced.csv"
...
backtest(raw_data["Close"][-pred_classes.shape[0]:], pred_classes, fees=0., slippage=0., use_step=85)
